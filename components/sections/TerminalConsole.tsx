    ...
    const [history, setHistory] = useState<CommandHistory[]>([
        {
            ...
            output: (
                <div className="space-y-1 text-amber-500 font-mono text-[11px] md:text-xs">
                    <div>[OK] Initializing hayath.sys core modules...</div>
            ...
            case "about":
                output = (
                    <div className="space-y-2 text-muted-foreground font-mono text-[11px] md:text-xs leading-relaxed">
                        <p>
                            <span className="text-foreground font-bold">Mohammed Hayath</span> is a Computer Science Graduate from MITS University (Class of 2024), specializing in high-performance distributed architectures and full-stack development. Has 13 months of hands-on experience as a Software Development Intern.
                        </p>
                        <p>
                ...
                output = (
                    <div className="space-y-3 text-muted-foreground font-mono text-[11px] md:text-xs">
                        <div>
                            ...
                            <br />
                            <span className="text-slate-500">Link: https://medium.com/@mohammedhayath/should-you-still-learn-to-code-in-2026-cccab3bac4a6</span>
                        </div>
                        <div>
                            ...
                            <br />
                            <span className="text-slate-500">Link: https://medium.com/@mohammedhayath/job-hunting-in-2026-what-nobody-tells-new-graduates-d2f4eafaf4d1</span>
                        </div>
                    </div>
                );
                break;
...
{`   ██████╗  ██████╗
   ...
   ╚═╝      ╚═╝  ╚═╝`}
                        ...
                        <div className="space-y-1 text-muted-foreground">
                            <div><span className="text-amber-500 font-bold">guest@hayath.sys</span></div>
                            <div>--------------------</div>
                            <div><span className="text-amber-500 font-bold">OS:</span> HayathOS v1.0.0 (Darwin arm64)</div>
                            <div><span className="text-amber-500 font-bold">Host:</span> MITS University Graduate (Class of 2024)</div>
            ...
            case "contact":
                output = (
                    <div className="space-y-1 text-muted-foreground font-mono text-[11px] md:text-xs">
                        <div><span className="text-amber-500 font-bold">Email:</span> snmdhayat@gmail.com</div>
                        <div><span className="text-amber-500 font-bold">Github:</span> github.com/amohammedhayath</div>
                        <div><span className="text-amber-500 font-bold">LinkedIn:</span> linkedin.com/in/snmdhayath</div>
                    </div>
                );
                break;
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-2xl text-base leading-relaxed">
                        Query Mohammed&apos;s developer parameters, stack topology, and core project specifications directly from a live interactive terminal gateway.
                    </p>
                </motion.div>
                            ...
                            <div key={index} className="space-y-1.5">
                                {item.command !== "system-init" && (
                                    <div className="flex items-center gap-2 text-foreground font-bold">
                                        <span className="text-amber-500">guest@hayath.sys:~$</span>
