...
const PROJECTS: Project[] = [
    {
        id: "prism-ai",
        title: "Prism AI",
        description: "A Semantic AI Agent that doesn't just read resumes, it optimizes them. Using Google Gemini 2.5 Flash, Vector Embeddings, and Agentic Workflows, it analyzes your resume against a target JD and rewrites your bullet points to match the job description.",
        tech: ["AI/LLMs", "Python", "React.js", "reddis", "celery"],
        github: "https://github.com/amohammedhayath/Prism-AI",
        live: "https://prisms-ai.vercel.app/",
        image: "/images/prism_ai_v1.png",
        category: "Tool",
    },
    {
        id: "agenticqa",
        title: "AgenticQA",
        description: "AgenticQA is a state-of-the-art, AI-driven automation framework that bridges the gap between natural-language test cases and robust, executed Gherkin specifications. Instead of relying on static, brittle element locators and pre-written step definitions, AgenticQA uses LangGraph orchestration and Gemini GenAI to autonomously parse English text, translate it to Gherkin features, generate missing step code on-the-fly using the live compressed browser DOM, execute tests, and permanently retain custom step definitions.",
        tech: ["AI/LLMs", "Python", "LangGraph", "Selenium", "Playwright"],
        github: "https://github.com/amohammedhayath/AgenticQA",
        live: "https://github.com/amohammedhayath/AgenticQA",
        image: "/images/agenticqa_v1.png",
        category: "Tool",
    },
    {
        id: "e-akhbar",
        ...
        github: "https://github.com/amohammedhayath/e-akhbar",
    ...
    },
    {
        ...
        github: "https://github.com/amohammedhayath/FlowKit",
    ...
    },
    {
        ...
        github: "https://github.com/amohammedhayath/Lynkforge---A-URL-Shortner-App",
    ...
    },
    {
        id: "calculatorapp",
        title: "CalculatorApp",
        description: "A modern calculator app with advanced features and a sleek design. Built with React and TypeScript for a smooth user experience.",
        tech: ["React", "TypeScript", "Tailwind CSS"],
        github: "https://github.com/amohammedhayath/CalculatorApp",
        live: "https://github.com/amohammedhayath/CalculatorApp",
        image: "/images/calculator_app_v1.png",
        category: "Tool",
    },
    {
        id: "ember-stone",
        ...
        github: "https://github.com/amohammedhayath/Ember-Stone",
    ...
    },
    {
        ...
        github: "https://github.com/amohammedhayath/MyPortfolio",
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    <Button variant="ghost" className="group text-muted-foreground hover:text-foreground text-lg font-bold" asChild>
                        <a href="https://github.com/amohammedhayath" target="_blank">
                            View More on GitHub
