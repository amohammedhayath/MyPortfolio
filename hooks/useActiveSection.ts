...
export function useActiveSection(
    ...
    useEffect(() => {
        const observerOptions: IntersectionObserverInit = {
            root: null, // viewport
            rootMargin: "-25% 0px -45% 0px", // 30% active trigger zone in the top-middle of the screen
            threshold: 0.05, // low threshold so both short and extremely tall sections trigger perfectly
        };
