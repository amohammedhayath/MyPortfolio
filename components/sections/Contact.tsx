                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <a href="mailto:snmdhayat@gmail.com" className="flex items-center gap-4 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground text-sm font-bold font-mono group-hover:text-amber-500 transition-colors">snmdhayat@gmail.com</p>
                                </div>
                            </a>

                            <a href="https://www.linkedin.com/in/snmdhayath/" target="_blank" className="flex items-center gap-4 group">
                                <div className="w-10 h-10 rounded border border-border bg-background flex items-center justify-center group-hover:border-amber-500/30 group-hover:bg-amber-500/5 transition-all duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground text-sm font-bold font-mono group-hover:text-amber-500 transition-colors">linkedin.com/in/snmdhayath</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex gap-3">
                            {[
                                { icon: FaGithub, href: "https://github.com/amohammedhayath" },
                                { icon: FaLinkedin, href: "https://www.linkedin.com/in/snmdhayath/" },
                                { icon: Mail, href: "mailto:snmdhayat@gmail.com" }
                            ].map((social, i) => (
