                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                I&apos;m <span className="text-foreground font-semibold">Mohammed Hayath</span>. I build robust distributed systems, high-performance backend microservices, and clean, responsive user interfaces. Passionate about system architecture, performance engineering, and turning complex problems into elegant, scalable digital products.
                            </motion.p>
                        </div>
